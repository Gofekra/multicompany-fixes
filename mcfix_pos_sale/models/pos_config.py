...
class PosConfig(models.Model):
    ...
    def _onchange_company_id(self):
        ...
        if self.company_id and self.crm_team_id.company_id and \
                self.crm_team_id.company_id != self.company_id:
    ...
    def _check_company_id_crm_team_id(self):
        for rec in self.sudo():
            if rec.company_id and rec.crm_team_id.company_id and\
                    rec.company_id != rec.crm_team_id.company_id:
